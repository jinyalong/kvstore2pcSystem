package cn.codefriday.kvstore2pcsystem.moudle_participant.controller;

import cn.codefriday.kvstore2pcsystem.moudle_participant.core.MainServer;
import cn.codefriday.kvstore2pcsystem.moudle_participant.participantCondition;
import cn.codefriday.kvstore2pcsystem.moudle_participant.resp.RespRequest;
import cn.codefriday.kvstore2pcsystem.moudle_participant.resp.RespResponse;
...
public class ParticipantController {
    ...
    public String GetKey(@RequestBody JSONObject jsonObject){
        System.out.println("DEBUG-GET请求：数据库大小："+server.getDatabase().database.size()+"===="+server.getDatabase().database);
        RespResponse response = new RespResponse();
        RespRequest respRequest = jsonObject.toJavaObject(RespRequest.class);
